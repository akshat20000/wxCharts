...
foreach(_cmake_expected_target IN ITEMS wxcharts::wxcharts)
...
# Create imported target wxcharts::wxcharts
add_library(wxcharts::wxcharts STATIC IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/wxcharts-config-*.cmake")
